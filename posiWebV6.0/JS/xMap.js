...
(function () {
	...
	myChart.on('click', function (params) {
		...
		timeFn = setTimeout(function () {
			...
			reloadPosiInfo(name.replaceAll(/[省|市|自治区|壮族自治区|回族自治区|维吾尔族自治区]/g, "").substring(0,2), select.value, select.selectValue.label,true)
	...
	myChart.on('dblclick', function (params) {
		...
		if (preCode.length != 1) {
			...
			reloadPosiInfo(codeAdd[1].replaceAll(/[省|市|自治区|壮族自治区|回族自治区|维吾尔族自治区]/g, "").substring(0,2), select.value, select.selectValue.label,true)
